...
function updateWrongLettersEl() {
  ...
  `;
	...
	if (wrongLetters.length === figureParts.length) {
		...
		finalMessageRevealWord.innerText = `...the Answer is: ${selectedWord}`;
		popup.style.display = 'flex';
...
playAgainBtn.addEventListener('click', () => {
	...
	const qnew =Math.floor(Math.random() * words.length)
	Question(qnew)
	selectedWord = words[qnew];
...
function Question (Qno) {
	document.getElementById("que").innerHTML =(questions[Qno])
}